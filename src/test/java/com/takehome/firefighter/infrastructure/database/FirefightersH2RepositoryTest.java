...
class FirefightersH2RepositoryTest {
    ...
    public void shouldFindNextFirefighter_whenOtherFirefightersWithDifferentNames() {
        ...
        //WHEN
        var actualFirefighter = firefighterH2Repository.findNextFirefighterAlphabetically(firefighter1);
    ...
    public void shouldFindNextFirefighter_whenOtherFirefightersWithSameNames() {
        ...
        //WHEN
        var actualFirefighter = firefighterH2Repository.findNextFirefighterAlphabetically(firefighter2);
